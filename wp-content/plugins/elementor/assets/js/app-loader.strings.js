...
__( 'Weâ€™re sorry, but something went wrong. Click on â€˜Learn moreâ€™ and follow each of the steps to quickly solve it.', 'elementor' );
...
__( 'The header template allows you to easily design and edit custom WordPress headers so you are no longer constrained by your themeâ€™s header design limitations.', 'elementor' );
...
__( 'The footer template allows you to easily design and edit custom WordPress footers without the limits of your themeâ€™s footer design constraints', 'elementor' );
...
__( 'An archive template allows you to easily design the layout and style of archive pages - those pages that show a list of posts (e.g. a blogâ€™s list of recent posts), which may be filtered by terms such as authors, categories, tags, search results, etc.', 'elementor' );
__( 'If youâ€™d like a different style for a specific category, itâ€™s easy to create a separate archive template whose condition is to only display when users are viewing that categoryâ€™s list of posts.', 'elementor' );
...
__( 'To import or export these components, youâ€™ll need Elementor Pro.', 'elementor' );
...
__( 'Something went wrong.', 'elementor' );
__( 'Nothing to worry about, use ðŸ”„ on the top corner to try again. If the problem continues, head over to the Help Center.', 'elementor' );
__( 'Learn More', 'elementor' );
...
__( 'We couldnâ€™t download the Website Template due to technical difficulties on our part. Try again and if the problem persists contact ', 'elementor' );
__( 'Support', 'elementor' );
__( 'Couldnâ€™t handle the Website Template', 'elementor' );
...
__( 'Couldnâ€™t use the .zip file', 'elementor' );
__( 'Seems like there is a problem with the zipâ€™s files. Try installing again and if the problem persists contact ', 'elementor' );
__( 'Support', 'elementor' );
__( 'Unable to download the Website Template', 'elementor' );
__( 'It took too much time to download your Website Template and we were unable to complete the process. If all the Website Templateâ€™s parts donâ€™t appear in ', 'elementor' );
__( 'Pages', 'elementor' );
__( ', try again and if the problem persists contact ', 'elementor' );
__( 'Support', 'elementor' );
__( 'Unable to download the Website Template', 'elementor' );
__( 'We couldnâ€™t download the Website Template due to technical difficulty on our part. Try again in a few minutes and if the problem persists contact ', 'elementor' );
__( 'Support', 'elementor' );
__( 'Couldnâ€™t access the file', 'elementor' );
__( 'Seems like Elementor isnâ€™t authorized to access relevant files for installing this Website Template. Contact your site host to get permission.', 'elementor' );
__( 'Couldnâ€™t install the Website Template', 'elementor' );
__( 'The Website Template includes plugins you donâ€™t have permission to install. Contact your site admin to change your permissions.', 'elementor' );
__( 'Unable to download the Website Template', 'elementor' );
...
__( 'Unable to download the Website Template', 'elementor' );
__( 'This download requires the \'DOMDocument\' PHP extension, which we couldnâ€™t detect on your server. Enable this extension, or get in touch with your hosting service for support, and then give the download another go.', 'elementor' );
__( 'Couldnâ€™t Export the Website Template', 'elementor' );
__( 'The export failed because it will pass the maximum Website Templates you can export.', 'elementor' );
__( 'Couldnâ€™t fetch quota', 'elementor' );
...
__( 'Import a Website Template', 'elementor' );
__( 'Whatâ€™s a Website Template?', 'elementor' );
__( 'A Website Template is a .zip file that contains all the parts of a complete site. Itâ€™s an easy way to get a site up and running quickly.', 'elementor' );
__( ' Learn more about Website Templates', 'elementor' );
__( 'How does importing work?', 'elementor' );
__( 'Start by uploading the file and selecting the parts and plugins you want to apply. If there are any overlaps between the kit and your current design, youâ€™ll be able to choose which imported parts you want to apply or ignore. Once the file is ready, the kit will be applied to your site and youâ€™ll be able to see it live.', 'elementor' );
__( 'Learn More', 'elementor' );
__( 'Export a Website Kit', 'elementor' );
__( 'Whatâ€™s a Website Kit?', 'elementor' );
__( 'A Website Kit is a .zip file that contains all the parts of a complete site. Itâ€™s an easy way to get a site up and running quickly.', 'elementor' );
__( ' Learn more about Website Kits', 'elementor' );
__( 'How does exporting work?', 'elementor' );
__( 'To turn your site into a Website Kit, select the templates, content, settings and plugins you want to include. Once itâ€™s ready, youâ€™ll get a .zip file that you can import to other sites.', 'elementor' );
__( 'Learn More', 'elementor' );
__( 'Setting up your website template...', 'elementor' );
__( 'This usually takes a few moments.', 'elementor' );
__( "Don't close this window until the process is finished.", 'elementor' );
...
__( 'Support', 'elementor' );
__( 'Learn more', 'elementor' );
__( 'Couldnâ€™t Upload to Library', 'elementor' );
__( 'We couldnâ€™t add your export to the library. Try again. ', 'elementor' );
__( 'Learn more', 'elementor' );
__( 'Unable to download the Website Template', 'elementor' );
__( 'We couldnâ€™t download the Website Template due to technical difficulties on our part. Try again and if the problem persists contact ', 'elementor' );
__( 'Support', 'elementor' );
__( 'Learn more', 'elementor' );
__( 'Couldnâ€™t save media files to the cloud', 'elementor' );
...
__( 'Parts of this kit overlap with your siteâ€™s templates, design and settings. The items you leave checked on this list will replace your current design.', 'elementor' );
__( 'Note:', 'elementor' );
...
__( 'By default, weâ€™ll include everything in your file. Uncheck the items you don\'t want.', 'elementor' );
__( 'Next', 'elementor' );
__( 'Learn More', 'elementor' );
...
__( 'If youâ€™ve purchased, installed & activated Elementor Pro, we can continue importing all the parts of this site.', 'elementor' );
__( 'Yes', 'elementor' );
...
__( 'You canâ€™t use this Website Kit because it doesnâ€™t contain any content, pages, etc. Try again with a different file.', 'elementor' );
__( 'Go Back', 'elementor' );
