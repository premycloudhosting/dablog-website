...
__( 'Class names canâ€™t contain spaces.', 'elementor' );
...
__( 'Class names canâ€™t start with a hyphen followed by a number.', 'elementor' );
__( 'This name is reserved and canâ€™t be used. Try something more specific.', 'elementor' );
